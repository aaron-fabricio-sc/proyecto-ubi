...
<head>
    ...
    <title>Lista de estudiantes contaduria </title>
    ...
    <header>
        ...
        <nav>
          <ul>
               ...
               <li> <a href="notas_contaduria.php"><span class="icon-pencil2"></span>NOTAS DE ESTUDIANTES</a></li>
