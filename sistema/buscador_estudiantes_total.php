...
include "../conexion.php";
    ...
    if(isset($_POST['consulta'])){
        ...
        $query="SELECT * FROM estudiantes WHERE nombre LIKE '%".$q."%' OR ap_paterno LIKE '%".$q."%' OR ap_materno LIKE '%".$q."%' OR carrera LIKE '%".$q."%'";
        ...
        if($resultado->num_rows >0 ){
            ...
            while($fila = $resultado -> fetch_assoc()){
                $salida.="<tr>
                            ...
                            <td>".$fila['gestion']."</td> 
                            <td>".$fila['turno']."</td> 
                            <td><a class='link_add' href='editar_estudiante.php? id=".$fila['id']."'>Editar</a> 
                             |
