...
<head>
    ...
    <title>Lista de estudiantes sistemas </title>
...
<body>
    ...
    <header>
        ...
        <nav>
          <ul>
               ...
               <li> <a href="notas_sistemas.php"><span class="icon-pencil2"></span>NOTAS DE ESTUDIANTES</a></li>
    ...
    <div class="contenedor1">
            <h2 class="titulo">LISTA DE ESTUDIANTES SISTEMAS</h2>
