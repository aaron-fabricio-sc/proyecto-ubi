...
<head>
    ...
    <title>Notas de estudiantes arquitectura </title>
</head>
<body>
    ...
    <header>
        ...
        <nav>
          <ul>
               ...
               <li> <a href="lista_estudiantes_arq.php"><span class="icon-user"></span>LISTA DE ESTUDIANTES</a></li>
    ...
    <div class="contenedor1">
            <h2 class="titulo">NOTAS DE ESTUDIANTES</h2>
                ...
                <?php   
                        ...
                        FROM estudiantes e INNER JOIN notas n ON e.id = n.estudiante WHERE e.carrera='ARQ'" );
