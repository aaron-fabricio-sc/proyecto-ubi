...
<head>
    ...
    <meta charset="UTF-8">
    <title>Registro de notas arquitectura</title>
    ...
    <?php include "header.php"?>
        ...
        <div class="menu">
          <a href="#" class="btn"><span class="icon-list"></span>Menu</a>      
                ...
                <li><a href="lista_estudiantes_arq.php" ><span class="icon-undo"></span>ATRAS</a></li>
            ...
            <div class="contenedor">
                    ...
                    <div class="alert"><?php  echo isset($alert) ? $alert : ''; ?></div>
                        ...
                        <input type="hidden" name="codnotaestu" value="<?php echo $iduser; ?>">
                         <?php
                          $query_rol = mysqli_query($conection,"SELECT * FROM carrera WHERE nombre_carrera='Arquitectura'");
                      ...
                      <?php
                        ...
                        <div>
                            <label for="EST" class="label_for1">MATERIA</label>
                            <?php
                          $query_rol = mysqli_query($conection,"SELECT * FROM materias WHERE carrera='Arquitectura'");
                          $result_rol = mysqli_num_rows($query_rol);
