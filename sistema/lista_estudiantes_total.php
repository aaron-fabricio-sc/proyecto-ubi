...
<head>
    ...
    <title>Lista de estudiantes ubi </title>
</head>
<body>
    ...
    <header>
        ...
        <nav>
          ...
          <li> <a href="registro_alumnos.php"><span class="icon-home"></span></span>REGISTRAR ESTUDIANTE</a></li> </div>
    ...
    <div class="contenedor1">
            <h2 class="titulo">LISTA DE ESTUDIANTES UBI</h2>
