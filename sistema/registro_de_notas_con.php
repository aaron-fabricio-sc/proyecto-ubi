...
<body>
    <?php include "header.php"?>
        ...
        <nav>
                ...
                <li><a href="lista_estudiantes_conta.php" ><span class="icon-undo"></span>ATRAS</a></li>                   
                </ul>
            ...
            <div class="contenedor">
                    ...
                    <div class="alert"><?php  echo isset($alert) ? $alert : ''; ?></div>
                        ...
                        <input type="hidden" name="codnotaestu" value="<?php echo $iduser; ?>">
                         <?php
                          $query_rol = mysqli_query($conection,"SELECT * FROM carrera WHERE nombre_carrera='Contaduria'");
                      ...
                      <?php
                        ...
                        <div>
                            ...
                            <?php
                          $query_rol = mysqli_query($conection,"SELECT * FROM materias WHERE carrera='Contaduria'");
                          $result_rol = mysqli_num_rows($query_rol);
